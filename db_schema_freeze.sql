...
\restrict hoJaawxc0DzA9StHfCgpGUBetXQMIarNBxpwZBcyYT1acVdMa2unkS8MtsR17If
...
CREATE TABLE public.bookings (
    ...
    created_at timestamp without time zone DEFAULT now(),
    request_id text,
    CONSTRAINT bookings_status_check CHECK ((status = ANY (ARRAY['pending_payment'::text, 'paid'::text, 'expired'::text, 'cancelled'::text, 'completed'::text])))
);
...
--
-- Name: salon_master_services; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.salon_master_services (
    id integer NOT NULL,
    ...
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    CONSTRAINT salon_master_services_duration_min_check CHECK ((duration_min > 0)),
    CONSTRAINT salon_master_services_price_check CHECK ((price >= 0))
);


--
-- Name: salon_master_services_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.salon_master_services ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.salon_master_services_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: salon_master_services salon_master_services_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.salon_master_services
    ADD CONSTRAINT salon_master_services_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.system_locks
    ADD CONSTRAINT system_locks_pkey PRIMARY KEY (lock_key);


--
-- Name: salon_master_services uq_sms_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.salon_master_services
    ADD CONSTRAINT uq_sms_unique UNIQUE (salon_id, master_id, service_pk);


--
-- Name: idx_async_jobs_pending; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_async_jobs_pending ON public.async_jobs USING btree (status, run_at);
...
--
-- Name: idx_sms_master_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sms_master_active ON public.salon_master_services USING btree (master_id, active);


--
-- Name: idx_sms_salon_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sms_salon_active ON public.salon_master_services USING btree (salon_id, active);


--
-- Name: idx_sms_service; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sms_service ON public.salon_master_services USING btree (service_pk);
...
--
-- Name: uniq_async_jobs_idem; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uniq_async_jobs_idem ON public.async_jobs USING btree (job_type, idempotency_key) WHERE (idempotency_key IS NOT NULL);
...
--
-- Name: salon_master_services fk_sms_master; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.salon_master_services
    ADD CONSTRAINT fk_sms_master FOREIGN KEY (master_id) REFERENCES public.masters(id) ON DELETE CASCADE;


--
-- Name: salon_master_services fk_sms_salon; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.salon_master_services
    ADD CONSTRAINT fk_sms_salon FOREIGN KEY (salon_id) REFERENCES public.salons(id) ON DELETE CASCADE;


--
-- Name: salon_master_services fk_sms_service; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.salon_master_services
    ADD CONSTRAINT fk_sms_service FOREIGN KEY (service_pk) REFERENCES public.services(id) ON DELETE CASCADE;
...
\unrestrict hoJaawxc0DzA9StHfCgpGUBetXQMIarNBxpwZBcyYT1acVdMa2unkS8MtsR17If
