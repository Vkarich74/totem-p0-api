...
export async function publishTemplateDraft(db, ownerType, ownerSlug, templateVersion = TEMPLATE_VERSION_V1, publishedBy = null){
  ...
  const published = normalizeTemplatePayload(ownerType, document.draft || {}, assets);
  const meta = {
    ...(document.meta || {}),
