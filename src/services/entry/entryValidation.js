...
export function validateEntryContractShape(contract = {}, baseUrl = null){
  ...
  return {
    ...
    public_absolute_url_valid: contract.public_absolute_url === expectedPublicAbsoluteUrl,
    cabinet_absolute_url_valid: contract.cabinet_absolute_url === expectedCabinetAbsoluteUrl,
    ...
    auth_login_absolute_url_valid: contract.auth_login_absolute_url === expectedAuth.auth_login_absolute_url,
...
export function buildEntryValidationSnapshot(resolvedEntry, authSnapshot = null, baseUrl = null){
  ...
  return {
    ...
    expected_payloads: {
      qr_payload: contract.public_absolute_url,
